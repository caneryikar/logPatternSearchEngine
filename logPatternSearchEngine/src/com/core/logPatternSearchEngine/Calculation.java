...
public class Calculation {
	...
	public int calculateCharCount() throws FileNotFoundException {
		...
		Scanner fileIn = new Scanner(new File("C:\\Users\\VAIO\\Desktop\\JAVA\\" + "consoleText.txt"));
	...
	public void readLineByLine() throws FileNotFoundException, UnsupportedEncodingException {
		...
		PrintWriter writer = new PrintWriter((new File("C:\\Users\\VAIO\\Desktop\\JAVA\\" + "croppedText.dat")),
				"UTF-8");

		try (BufferedReader br = new BufferedReader(
				new FileReader("C:\\Users\\VAIO\\Desktop\\JAVA\\" + "consoleText.txt"))) {
			String line;
